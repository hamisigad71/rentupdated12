      ...
      >
        ...
        >
          ...
          <div className="flex-1 p-6 space-y-5 overflow-y-auto">
            ...
            <div className="rounded-2xl border border-border bg-muted/30 aspect-[3/4] flex items-center justify-center relative overflow-hidden">
              ...
              <div className="text-center space-y-3 p-8">
                <doc.icon
                  className={cn("h-16 w-16 mx-auto", doc.color)}
                  strokeWidth={1}
                />
                <p className="font-bold text-sm text-foreground/60">
                  {doc.name}
                </p>
                <p className="text-xs text-muted-foreground">
            ...
            <div className="rounded-2xl border border-primary/20 bg-emerald-soft p-4 flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-[10px] text-primary/60 font-medium">
                  Cryptographic hash confirmed · AES-256 encrypted
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="p-6 border-t border-border flex gap-3">
            ...
            <Button
              variant="outline"
              className="flex-1 rounded-2xl font-bold h-12 gap-2"
            >
...
export default function TenantDocumentsPage() {
  ...
  const [previewDoc, setPreviewDoc] = useState<(typeof MOCK_DOCS)[0] | null>(
    null,
  );
  ...
  return (
    <TenantLayout>
      <div className="py-6 md:p-8 space-y-8 max-w-7xl mx-auto">
        {/* ── HEADER ─────────────────────────────────────────────────────── */}
        <Reveal className="flex flex-col sm:flex-row sm:items-start justify-between gap-6">
          <div className="space-y-2">
            ...
            <p className="text-sm text-muted-foreground font-medium">
              All your lease, financial, and legal documents in one secure
              place.
            </p>
          </div>
                    ...
                    >
                      {mode === "list" ? (
                        <div className="flex flex-col gap-0.5">
                          <div className="w-3.5 h-px bg-current rounded" />
                          <div className="w-3.5 h-px bg-current rounded" />
                          <div className="w-3.5 h-px bg-current rounded" />
                        </div>
                      ) : (
                        <div className="grid grid-cols-2 gap-0.5">
                          <div className="w-1.5 h-1.5 bg-current rounded-[2px]" />
                          <div className="w-1.5 h-1.5 bg-current rounded-[2px]" />
                          <div className="w-1.5 h-1.5 bg-current rounded-[2px]" />
                          <div className="w-1.5 h-1.5 bg-current rounded-[2px]" />
                        </div>
                    ...
                    <div className="divide-y divide-border/60">
                      {filtered.map((doc, i) => (
                        ...
                        >
                          ...
                          >
                            <doc.icon
                              className={cn("h-5.5 w-5.5", doc.color)}
                              strokeWidth={1.5}
                            />
                          </div>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                      {filtered.map((doc, i) => (
                        ...
                        >
                          ...
                          >
                            <doc.icon
                              className={cn("h-6 w-6", doc.color)}
                              strokeWidth={1.5}
                            />
                          </div>
                          <div className="flex-1 min-w-0">
            ...
            <div className="rounded-3xl border border-border bg-card p-6 h-full">
              <div className="flex items-center justify-between mb-6">
                ...
                <Button
                  variant="ghost"
                  size="sm"
                  className="text-xs font-bold text-muted-foreground h-8 px-3 rounded-xl hover:text-primary"
                >
              ...
              <div className="space-y-1">
                {[
                  {
                    action: "Downloaded",
                    doc: "Feb 2024 Rental Settlement Receipt",
                    time: "2 hours ago",
                    icon: Download,
                    color: "text-blue-500",
                  },
                  {
                    action: "Viewed",
                    doc: "Fully Executed Lease Agreement",
                    time: "Yesterday",
                    icon: Eye,
                    color: "text-emerald-mid",
                  },
                  ...
                  <div
                    key={i}
                    className="flex items-center gap-4 px-4 py-3 rounded-xl hover:bg-muted/40 transition-colors group cursor-pointer"
                  >
                    <div
                      className={cn(
          ...
          <Reveal delay={0.2}>
            <div className="rounded-3xl border border-border bg-card p-6 flex flex-col gap-5 h-full">
                ...
                {[
                  {
                    ...
                    desc: "Ask your landlord for a file",
                    icon: Bell,
                    primary: true,
                  },
                  {
                    label: "Download All",
                    desc: "Export a ZIP of your vault",
                    icon: Download,
                    primary: false,
                  },
                  {
                    label: "Share Document",
                    desc: "Send securely via email",
                    icon: ArrowUpRight,
                    primary: false,
                  },
                  {
                    label: "Report an Issue",
                    desc: "Flag a missing document",
                    icon: AlertCircle,
                    primary: false,
                  },
                ].map((action, i) => (
              ...
              <div className="rounded-2xl bg-muted/30 border border-border p-4">
                ...
                <p className="text-[10px] text-muted-foreground/50 font-medium mt-1.5">
                  90.9 MB available
                </p>
              </div>
            </div>
        ...
        <Reveal delay={0.1}>
          <div className="rounded-3xl border border-border bg-card overflow-hidden relative">
            ...
            <div className="relative z-10 grid lg:grid-cols-2 gap-0 divide-y lg:divide-y-0 lg:divide-x divide-border">
              ...
              <div className="p-8 space-y-6">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground leading-relaxed font-medium max-w-sm">
                    Every file is encrypted at rest and in transit.
                    Cryptographic hashes verify integrity on every access, so
                    you always know your documents are authentic and untampered.
                  </p>
                </div>
              ...
              <div className="p-8">
                <p className="text-xs font-bold uppercase tracking-widest text-muted-foreground/40 mb-5">
                ...
                <div className="grid grid-cols-2 gap-3">
                  {[
                    ...
                    },
                    {
                      label: "ISO 27001",
                      icon: Star,
                      desc: "Info security certified",
                    },
                    {
                      label: "PCI DSS",
                      icon: CreditCard,
                      desc: "Payment card standard",
                    },
                    {
                    ...
                    <div
                      key={i}
                      className="flex items-center gap-3 p-3.5 rounded-2xl border border-border bg-background hover:border-primary/25 hover:bg-primary/3 transition-all group cursor-default"
                    >
...
function EmptyState() {
  return (
    <div className="py-20 flex flex-col items-center justify-center text-center space-y-4 px-6">
      ...
      <Button
        variant="outline"
        className="rounded-xl h-10 px-6 font-bold text-sm mt-2"
      >
        Clear filters
      </Button>
    </div>
