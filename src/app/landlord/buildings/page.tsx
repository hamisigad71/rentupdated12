  ...
  return (
    <LandlordLayout>
          ...
          {[
            {
              ...
              icon: Building2,
              sub: "Managed Buildings",
            },
            {
              label: "Portfolio Yield",
              val: `KSh ${(totalRevenue / 1000).toFixed(1)}K`,
              icon: TrendingUp,
              sub: "Net Monthly Rev",
            },
            {
              ...
              val: `${portfolioOcc}%`,
              icon: Target,
              sub: `${totalOccupied}/${totalUnits} Units`,
            },
            {
              label: "Global Units",
              val: totalUnits,
            ...
            >
              ...
              <p className="text-3xl font-bold tracking-tight mb-1 uppercase leading-none">
                {stat.val}
              </p>
                  ...
                  <div className="relative h-56 overflow-hidden">
                    ...
                    <div className="absolute bottom-6 left-6 right-6 space-y-3">
                      <div className="flex items-end justify-between text-white">
                        <div className="space-y-1">
                          <p className="text-[9px] font-bold uppercase  opacity-50 leading-none">
                            Yield Index
                          </p>
                  ...
                  <div className="p-8 flex flex-col flex-1 gap-6">
                    ...
                    <div className="grid grid-cols-4 gap-2">
                      {[
                        ...
                        {
                          l: "Vac.",
                          v: building.units - building.occupiedUnits,
                        },
                        { l: "Est.", v: building.yearBuilt },
                      ].map((s, idx) => (
                        <div
                          key={idx}
                          className="p-2.5 rounded-xl bg-foreground/[0.02] border border-foreground/5 text-center"
                        >
                          <p className="text-[8px] font-bold uppercase  text-muted-foreground/40 mb-1">
                            {s.l}
                          </p>
                    ...
                    <div className="flex items-center gap-3 mt-auto">
                      <Button
                        onClick={() =>
                          router.push(`/landlord/buildings/${building.id}`)
                        }
      ...
      <Dialog open={showAddModal} onOpenChange={setShowAddModal}>
        <DialogContent className="max-w-[95vw] sm:max-w-[calc(100vw-2rem)] md:max-w-[1000px] p-0 overflow-hidden rounded-2xl border-none shadow-2xl bg-background h-[90vh]">
            ...
            <div className="relative h-44 shrink-0 bg-[#0F0F0F] p-5 flex flex-col justify-center">
              ...
              <div className="relative z-10 space-y-2">
                ...
                <h2 className="text-xl font-bold tracking-tight text-white uppercase">
                  Asset <span className="text-primary ">Onboarding</span>
                </h2>
              </div>
              <Button
                variant="ghost"
                ...
                <div className="space-y-6">
                        ...
                        <button
                          ...
                          className={cn(
                            ...
                            formData.amenities.includes(name)
                              ...
                              : "bg-foreground/[0.02] border-foreground/5 text-muted-foreground/40 hover:border-foreground/20",
                          )}
                        >
                          {icon}
                          <span className="text-[7px] font-bold uppercase  truncate w-full text-center">
                            {name}
                          </span>
                        </button>
                      ))}
                  ...
                  <Field label="Visual Identity">
                    <div className="relative h-32 rounded-2xl border-2 border-dashed border-foreground/10 bg-foreground/[0.02] flex flex-col items-center justify-center gap-2 cursor-pointer hover:border-primary/20 transition-all group/upload">
                      ...
                      <p className="text-[9px] font-bold uppercase  text-muted-foreground/30 group-hover:text-primary transition-colors">
                        Capture Asset Photo
                      </p>
                      <input
                        type="file"
